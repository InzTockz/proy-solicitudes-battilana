...
public class UsuarioController {
    ...
    @GetMapping("/find/almacenes/{codVendedor}")
    ResponseEntity<List<AlmacenResponse>> buscarAlmacenesPorCodVendedor(@PathVariable Integer codVendedor) {
        return ResponseEntity.status(HttpStatus.OK).body(this.usuarioService.findAlmacenesEntityByCodVendedor(codVendedor));
    }
